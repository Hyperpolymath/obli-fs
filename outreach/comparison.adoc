...
. *Typed storage entities with bounded behaviour*
...
. *Consent-based channel creation*
...
|Actor system
|Erlang/OTP is battle-tested

|OS-level security
|Capability system
|seL4 for high-assurance

|Structured queries
|Database
|SQL is well-understood

|Typed storage coordination with audit
|*ObliFS*
