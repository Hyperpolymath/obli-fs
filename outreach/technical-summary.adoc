...
|Execute, mutate, communicate

|*Actor*
|Active entity with state
|Receive messages, transform state, emit messages
|Arbitrary I/O, spawn processes, escape type bounds

|*Channel*
|Message conduit
|Forward typed messages
|Store state, transform content

|*Router*
|Message routing
|Route based on headers
|Read message content, create channels

|*Workflow*
|Operation composition
|Sequence operations, handle errors
|Bypass consent, violate type bounds

|*Archive*
|Historical preservation
|Store, retrieve, prove provenance
...
_ObliFS is part of the Oblíbený project._
